...
public class MessageReader
{
   ...
   public Message readMessage() throws IOException, DBusException
   {
      ...
      if (len[0] < 12) {
         ...
         if (-1 == rv) throw new EOFException(getString("Underlying transport returned EOF"));
         len[0] += rv;
      }
      ...
      if (protover > Message.PROTOCOL) {
         buf = null;
         throw new MessageProtocolVersionException(MessageFormat.format(getString("Protocol version {0} is unsupported"), new Object[] { protover }));
      }
      ...
      switch (type) {
         ...
         case Message.MessageType.ERROR:
            ...
            break;
         default:
            throw new MessageTypeException(MessageFormat.format(getString("Message type {0} unsupported"), new Object[] {type}));
      }
      if (Debug.debug) {
