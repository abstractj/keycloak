 ...
 * @version $Revision: 1 $
 */
public class PAMAuthenticator implements Authenticator {

    public static final String CREDENTIAL_TYPE = "pam-authenticator";
    ...
    public void authenticate(AuthenticationFlowContext context) {
        ...
        LOGGER.info("" + context.getUser().getEmail());
        LOGGER.info("" + context.getUser().getUsername());
        LOGGER.info("===============================================================");
